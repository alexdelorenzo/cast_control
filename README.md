...
On Arch, you'll want to install `python-gobject` and `gobject-introspection`, or install `cast_control` [directly from the AUR](https://aur.archlinux.org/packages/cast_control/).
